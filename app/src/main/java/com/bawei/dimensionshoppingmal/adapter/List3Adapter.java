...
public class List3Adapter extends BaseAdapter {
    ...
    public List3Adapter(Context context, List<ListBean.ResultBean.PzshBean.CommodityListBeanX> commodityList2) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ListBean.ResultBean.PzshBean.CommodityListBeanX commodityListBean = commodityList.get(position);
